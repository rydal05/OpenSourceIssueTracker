export default function Intro({setRawSearch, setGeminiResult}: 
    {setRawSearch: React.Dispatch<React.SetStateAction<string>>}) {

    return (
        <div className="hidden z-10 flex py-10 px-10 flex-col text-3xl absolute w-md bg-white border-1 rounded-lg top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
